...
class DatasetP(object):
    ...
    def load_dataset(self, dataset_filepaths, parameters, token_to_vector=None, pretraining_dataset = None, remap_unknown_tokens_to_unk = True):
        '''
        dataset_filepaths : dictionary with keys 'train', 'valid', 'test', 'deploy'
        '''
        start_time = time.time()
